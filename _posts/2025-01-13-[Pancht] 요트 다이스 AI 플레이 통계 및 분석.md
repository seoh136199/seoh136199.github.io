...
<div style="position: relative; width: 100%; height: 0; padding-top: 75.0000%;
 padding-bottom: 0; margin-bottom: 10px; overflow: hidden;
 border-radius: 8px; will-change: transform;">
  ...
  <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border-radius: 8px; pointer-events: none; box-shadow: inset 0 0 0 1px rgb(84, 84, 84);"></div>
</div>
