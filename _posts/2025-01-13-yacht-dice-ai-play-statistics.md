...
지난번 게시글에서는 [요트 다이스 최적 선택 알고리즘을 구현한 방법](https://seoh136199.github.io/posts/Pancht-%EC%9A%94%ED%8A%B8-%EB%8B%A4%EC%9D%B4%EC%8A%A4-%EC%B5%9C%EC%A0%81-%EC%84%A0%ED%83%9D-%EC%95%8C%EA%B3%A0%EB%A6%AC%EC%A6%98%EC%9D%84-%EA%B5%AC%ED%98%84%ED%95%9C-%EB%B0%A9%EB%B2%95/)을 소개하며, 평균 점수 200점대 초반이라는 준수한 성능을 보였다고 언급했었다. 게임 플레이 에이전트를 만들었으니, 통계와 분석을 진행해 보는 것이 당연한 수순이다. 이번에는 평균 점수뿐만 아니라 다양한 데이터를 추출하여 시각화해 보았다.
<br><br>
